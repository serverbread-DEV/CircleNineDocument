...
export default {
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "其它", link: "/docs/before-start/other" },
          { text: "===开始学习===" },
          { text: "你的电脑", link: "/docs/learn/your-computer" },
          { text: "常用软件的使用方法", link: "/docs/learn/common-software" },
          { text: "什么是文件", link: "/docs/learn/what-is-file" },
          { text: "什么是exe（可执行文件）", link: "/docs/learn/what-is-exe" },
          {
            text: "如何正确在网络上检索信息",
            link: "/docs/learn/how-to-search",
          },
          { text: "如何解压", link: "/docs/learn/how-to-unarchive" },
          {
            text: "分享资源的常见方式",
            link: "/docs/learn/common-ways-2-share-resources",
          },
          { text: "有关链接的诸多问题", link: "/docs/learn/about-link" },
          { text: "速通Steam安装", link: "/docs/learn/how-to-install-steam" },
    ...
    socialLinks: [
      ...
      {
        icon: "github",
        link: "https://github.com/serverbread-DEV/CircleNineDocument",
      },
    ],
  },
};
